      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse container is-footer__collapse">
          <div class="col-md-8">
            <div class="row">
              <div class="col-md-12">
                <a v-for="(contact, index) in contactsItems" :key="index" :href="contact.link" target="_blank">
                  <i :class="contact.iconFa"></i>
                  {{ contact.name }}
                </a>
              </div>
              <div class="col-md-12">
                <div style="margin-bottom:.5em">
                  <a v-for="(social, index) in socialItems" :key="index" class="btn" :href="social.link" target="_blank">
                    <i :class="social.iconFa"></i>
                  </a>
                </div>
              </div>
            </div>
